...
abstract class FlxCameraView implements IFlxDestroyable
{
	...
	/**
	 * Whenever the display sprite should be rotated.
	 */
	public var rotateSprite(default, set):Bool;
	...
	{
		camera.setRotateSpriteBypass(rotate);
		return this.rotateSprite = rotate;
	}
