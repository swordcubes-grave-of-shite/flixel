...
class FlxQuadView extends FlxCameraView
{
	...
	override function set_rotateSprite(value:Bool):Bool
	{
		flashSprite.rotation = (value) ? camera.angle : 0;
		return super.set_rotateSprite(value);
	}

	override function set_angle(value:Float):Float
	{
		flashSprite.rotation = (camera.rotateSprite) ? value : 0;
